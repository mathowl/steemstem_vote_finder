...
# outputs a .txt of steemstem voted and tagged links of a steem user. The .txt file is titled USER_steemstem where USER is the requested user. The .txt file is html coded and contains refs to the corresponding posts. 
